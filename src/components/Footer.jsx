    ...
    return (
        <footer className="flex flex-col items-center py-12 px-10 bg-footer-bg border-t border-border  text-muted-text">
            <section className="grid grid-cols-[repeat(auto-fit,minmax(320px,1fr))] gap-16 w-full justify-items-center-safe max-[1124px]:grid-cols-2 max-[710px]:grid-cols-1">
                <div className="w-80">
                    <h3 translate="no" className="mb-4 text-secondary-text">
                        Film Vault
                    </h3>
                    <p>{t("footer.description")}</p>
                </div>
                <ul className="flex flex-col gap-2 w-80">
                    <li className="text-secondary-text mb-2">{t("footer.techStack")}</li>
                    <li>React.js</li>
                    <li>Tailwind CSS</li>
                    <li>API (TMDb)</li>
                    <li>GitHub Pages</li>
                ...
                <div className="flex flex-col gap-2 w-80">
                    <p className="text-secondary-text mb-2">Links</p>
                    <a
                        className="hover:text-secondary-text transition-colors duration-300 ease"
