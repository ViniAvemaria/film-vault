    ...
    return (
        <>
            <div
                ...
                className="flex flex-col gap-2 justify-between min-w-50 bg-card-bg border border-border rounded-lg p-3 group  cursor-pointer"
            >
                <div className="relative overflow-hidden">
                    ...
                    />
                    <span className="absolute text-sm top-0 right-0 flex items-center bg-secundary-bg py-0.75 px-2 rounded-lg m-0.5">
